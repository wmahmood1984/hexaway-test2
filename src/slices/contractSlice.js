...
export const readName = createAsyncThunk(
  ...
  async (a, thunkApi) => {
    ...
    try {
      ...
      const registered = await safeCall("userRegistered", () => contract.methods.userRegistered("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
      ...
      if (a.address && registered) {
        Package = await safeCall("userPackage", () => contract.methods.userPackage("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        uplines = await safeCall("getUplines", () => contract.methods.getUplines("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        downlines = await safeCall("getDownlines", () => contract.methods.getUser("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        allowance = await safeCall("allowance", () => uContract.methods.allowance("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459", mlmcontractaddress).call());
        //      directReferrals = await safeCall("getDirectReferrals", () => contract.methods.getDirectReferrals("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        limitUtilized = await safeCall("userLimitUtilized", () => contract.methods.userLimitUtilized("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        myNFTs = await safeCall("getNFTs(address)", () => contract.methods.getNFTs("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        NFTQueBalance = await safeCall("NFTQueBalance", () => contract.methods.NFTQueBalance("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        tradingReferralBonus = await safeCall("levelIncome", () => contract.methods.tradingReferralBonus("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        packageReferralBonus = await safeCall("referralIncome", () => contract.methods.packageReferralBonus("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        tradingLevelBonus = await safeCall("tradingIncome", () => contract.methods.tradingLevelBonus("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        packageLevelBonus = await safeCall("tradingIncome", () => contract.methods.packageLevelBonus("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        selfTradingProfit = await safeCall("tradingIncome", () => contract.methods.selfTradingProfit("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        walletBalance = await safeCall("walletbalance", () => uContract.methods.balanceOf("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        nftListed = await safeCall("nftlisted", () => contract.methods.getNFTListed("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        nftPurchaseTime = await safeCall("nftPurchaseTime", () => contract.methods.userTradingTime("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        incomeBlockTime = await safeCall("userLevelIncomeBlockTime", () => contract.methods.userLevelIncomeBlockTime("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
        userTradingTime = await safeCall("userTradingTime", () => contract.methods.userTradingTime("0x8A1406b54eaE828E4034c4Dc78d5dB3C1D22b459").call());
