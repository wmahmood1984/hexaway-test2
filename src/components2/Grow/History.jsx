    ...
    <div>
      <div style={{background:"#f8fafc", padding:"16px", borderRadius:"12px", borderLeft:"4px solid #10b981"}}>
          ...
          {statusText==='Active' ?
            ...
            id="claimRewardsBtn" style={{background:"linear-gradient(135deg,#10b981,#059669)", color:"white", border:"none", padding:"16px 32px", borderRadius:"12px", cursor:"pointer", fontSize:"clamp(16px,3.5vw,18px)", fontWeight:"900", boxShadow:"0 8px 20px rgba(16,185,129,0.4)", minWidth:"40px", marginBottom:"8px"}}>🎁 Claim All Rewards</button>  
        }
