...
export const growFundContractR = new web3.eth.Contract(growfundAbi,growFundAdd)

export const growFundContract = {
	address: growFundAdd,
	abi: growfundAbi,
};
